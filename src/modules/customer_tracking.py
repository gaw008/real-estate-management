...
class CustomerTrackingManager:
    ...
    def delete_customer(self, customer_id: int) -> bool:
        ...
        try:
            query = "UPDATE customers SET deleted_at = CURRENT_TIMESTAMP WHERE id = %s"
    ...
    def get_all_customers(self, page: int = 1, per_page: int = 20, search: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            if search:
                where_conditions.append("(name LIKE %s OR phone LIKE %s OR email LIKE %s)")
    ...
    def delete_tracking_record(self, record_id: int) -> bool:
        ...
        try:
            query = "UPDATE customer_tracking_records SET deleted_at = CURRENT_TIMESTAMP WHERE id = %s"
