...
class CustomerTrackingManager:
    ...
    def add_customer(self, customer_data: Dict[str, Any]) -> Optional[int]:
        ...
        try:
            ...
            values = (
                ...
                rental_types_json,
                customer_data.get('contract_date', None),
        ...
        try:
            ...
            query = """
                ...
                SET name = %s, phone = %s, email = %s, property_address = %s, 
                    rental_types = %s, contract_date = %s, notes = %s, updated_at = CURRENT_TIMESTAMP
    ...
    def get_all_customers(self, page: int = 1, per_page: int = 20, search: str = '', status: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            # 注意：由于数据库中没有tracking_status字段，我们暂时忽略status过滤
            # if status:
            ...
            for customer in customers:
                ...
                # 添加一个默认的tracking_status字段以兼容模板
                customer['tracking_status'] = '初始接触'
