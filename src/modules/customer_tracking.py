...
class CustomerTrackingManager:
    ...
    def delete_customer(self, customer_id: int) -> bool:
        ...
        try:
            query = "UPDATE customers SET deleted_at = NOW() WHERE id = %s AND deleted_at IS NULL"
    ...
    def delete_tracking_record(self, record_id: int) -> bool:
        ...
        try:
            query = "UPDATE customer_tracking_records SET deleted_at = NOW() WHERE id = %s AND deleted_at IS NULL"
