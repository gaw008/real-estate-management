...
class FinancialReportsManager:
    ...
    def create_reports_table(self):
        ...
        try:
            # 创建财务报表管理表（新表，避免与现有financial_reports表冲突）
            reports_sql = """
    ...
    def add_financial_report(self, property_id, report_year, report_month, report_title, onedrive_link, uploaded_by, notes=None):
        ...
        try:
            ...
            if existing:
                ...
                # 插入新报表
                insert_sql = """
                    INSERT INTO financial_report_files (property_id, report_year, report_month, report_title, onedrive_link, uploaded_by, notes)
    ...
    def get_owner_reports(self, owner_id, year=None, limit=None):
        ...
        try:
            ...
            query_sql = f"""
                ...
                JOIN financial_report_files fr ON pa.property_id = fr.property_id
    ...
    def get_all_reports(self, year=None, month=None, property_id=None, page=1, per_page=20):
        ...
        try:
            ...
            count_sql = f"""
                ...
                FROM financial_report_files fr
                WHERE {where_clause}
            """
    ...
    def get_properties_list(self):
        ...
        if not conn:
            # 数据库连接失败时使用模拟数据
            try:
                from utils.mock_data_manager import mock_data_manager
    ...
    def get_report_stats(self):
        ...
        try:
            ...
            # 总报表数
            cursor.execute("SELECT COUNT(*) as total FROM financial_report_files WHERE is_active = TRUE")
